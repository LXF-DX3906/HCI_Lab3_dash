...
df = pd.read_csv('lab3-datasets\BlackFriday.csv')
...
row3 = html.Div([
    ...
    html.Div([
            dcc.Graph(
                    ...
                    figure={
                        'data': [
                            {'x': df['Stay_In_Current_City_Years'].sort_values().unique(), 'y': dff2[0], 'type': 'bar', 'name': '0'},
                            {'x': df['Stay_In_Current_City_Years'].sort_values().unique(), 'y': dff2[1], 'type': 'bar', 'name': '1'},
                        ],
                        'layout': {
